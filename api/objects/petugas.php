<?php
    class Petugas{
        ...
        function create(){
            $query = "INSERT INTO " . $this->table_nama . " SET id_petugas = '$this->id_petugas', nama_petugas='$this->nama_petugas', pendidikan='$this->pendidikan', jk_petugas='$this->jk_petugas', tempat_lahir_petugas='$this->tempat_lahir_petugas', tgl_lahir_petugas='$this->tgl_lahir_petugas', alamat_petugas='$this->alamat_petugas',no_telp_petugas='$this->no_telp_petugas'";
