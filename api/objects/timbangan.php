<?php
	...
	class Timbangan  {
		...
		public function read(){
			...
			ref_anak.id_ibu, ibu.nama_ibu, ibu.alamat_ibu, ref_anak.status_kel,
			...
			" LEFT JOIN ibu ON ref_anak.id_ibu = ibu.id_ibu";
		...
		public function readPagination(){
			...
			" LEFT JOIN ref_anak ON trn_timbangan.id_anak = ref_anak.id_anak".
			" LEFT JOIN ibu ON ref_anak.id_ibu = ibu.id_ibu LIMIT $this->startPage, $this->dataPerPage";
		...
		function read_one(){
			...
			ref_anak.jk_anak, ref_anak.tgl_lahir_anak, trn_timbangan.berat_badan, trn_timbangan.tinggi_badan FROM ".$this->table_nama. 
			" LEFT JOIN ref_anak ON trn_timbangan.id_anak = ref_anak.id_anak".
			" LEFT JOIN ibu ON ref_anak.id_ibu = ibu.id_ibu WHERE id_timbangan='$this->id_timbang'";
        ...
        public function dataRekap(){
            $query = "SELECT trn_timbangan.id_timbangan, trn_timbangan.id_anak, ref_anak.nama_anak, 
			ref_anak.id_ibu, ibu.nama_ibu, ibu.alamat_ibu, ref_anak.status_kel, trn_timbangan.tanggal_penimbangan,
			...
			" LEFT JOIN ref_anak ON trn_timbangan.id_anak = ref_anak.id_anak".
			" LEFT JOIN ibu ON ref_anak.id_ibu = ibu.id_ibu WHERE tanggal_penimbangan BETWEEN '$this->fromDate' AND '$this->toDate'";
