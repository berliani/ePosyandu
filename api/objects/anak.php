...
class Anak{
		...
		public function read(){
			$query = "SELECT ref_anak.id_anak, ref_anak.nama_anak, ref_anak.nik_anak, ref_anak.tempat_lahir_anak, 
					ref_anak.tgl_lahir_anak, ref_anak.usia_anak, ref_anak.jk_anak, ibu.nama_ibu FROM ".$this->table_nama.
		...
		public function read_one(){
            ...
            $query = "SELECT ref_anak.id_anak, ref_anak.nama_anak, ref_anak.nik_anak, ref_anak.tempat_lahir_anak, 
			ref_anak.tgl_lahir_anak, ref_anak.usia_anak, ref_anak.jk_anak, ibu.id_ibu FROM ".$this->table_nama.
			" LEFT JOIN ibu ON ref_anak.id_ibu = ibu.id_ibu WHERE id_anak = '$this->id_anak'";
