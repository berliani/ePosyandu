...
<html lang="en">
  <head>
    ...
    <style type="text/css">
      body{
        background:url(img/Login/bgbaru.png);
        ...
        <div id="container">
          <div id="Login">
            ...
            <table class="username">
              <tr>
                  <td><input type="text" name="username" id="username" value="admin" placeholder="username" class="" style="height: 42px; width: 130%; margin-left: 20px; margin-top: 3px; border: none;"></td>
              </tr>
            ...
            <tr>
                 <td><input type="password" name="password" id="password" value="admin" placeholder="password" style="height: 42px; width: 130%; margin-left: 20px; margin-top: 16px; border: none;"></td>
              </tr>
            </table>
