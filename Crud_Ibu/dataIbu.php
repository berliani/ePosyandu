...
<body>
	...
	<p> 
		...
		No telp :<br> 
		<input type="text" id="no_kontak" size="30"><br> 
	...
	<script>
		...
		$(document).ready(function(){
			...
			$("#tupdate").click(function(){
				...
				data_ibu = "&option_nik_ibu="+option_nik_ibu+"&nama_ibu="+nama_ibu+"&alamat="+alamat+"&no_kontak="+no_kontak;
			...
			$("#ttambah").click(function(){ 
				...
				alamat = $("#alamat").val(); 
				no_kontak = $("#no_kontak").val(); 
				data_ibu = "&nik_ibu="+nik_ibu + "&nama_ibu="+nama_ibu+"&alamat="+alamat+"&no_kontak="+no_kontak;
