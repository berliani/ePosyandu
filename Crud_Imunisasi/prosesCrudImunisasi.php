<?php
    ...
    if($func_imun == "update_data_imun"){
        ...
        $tambah = mysqli_query($conn, "INSERT INTO ref_imunisasi(id_imunisasi, tgl_imunisasi, tinggi_badan, berat_badan, periode) 
                        VALUES('', '$tgl_imunisasi','$tinggi_badan','$berat_badan', '$periode')");
